...
type RecordAddLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewRecordAddLogic(ctx context.Context, svcCtx *svc.ServiceContext) RecordAddLogic {
	return RecordAddLogic{
...
func (l *RecordAddLogic) RecordAdd(req types.Zone) (resp *types.BaseResp, err error) {
	var (
		out []byte
	)
	z := zone{}
